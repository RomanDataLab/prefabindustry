# EU Prefab Home Companies Research

This script performs deep continuous research of all prefab home companies in the EU using OpenAI API.
...
Or directly:
```bash
node core/researchPrefabCompanies.js
```
